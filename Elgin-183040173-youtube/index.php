...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyDMcoApAwpcFuzjRvyIeOs-3gmM4HCIrl0');

$youtubeProfilePic = $result['items'][0]['snippet']['thumbnails']['medium']['url'];
$channelName = $result['items'][0]['snippet']['title'];
$sucbscriber = $result['items'][0]['statistics']['subscriberCount'];

//latest video//
$urlLatestVideo ='https://www.googleapis.com/youtube/v3/search?key=AIzaSyDMcoApAwpcFuzjRvyIeOs-3gmM4HCIrl0&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date&part=snippet';
...
<section class="social-media bg-light"  id="social-media">
 ...
 <div class="row justify-content-center">
   <div class="col-md-5">
     <div class="row">
     <div class="col-md-4">
     <img src="<?= $youtubeProfilePic; ?>" class="img-circle img-thumbnail">
    </div>
    <div class="col-md-8">
    <h5><strong><?= $channelName; ?></strong></h5>
    <p><?= $sucbscriber; ?>Subscribers.</p>
    </div>
    </div>
